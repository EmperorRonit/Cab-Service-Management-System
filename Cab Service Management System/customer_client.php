...
<html>
    ...
    while($row = mysqli_fetch_array($res)){
        ...
        echo "<td>".$row['dob']."</td>";
        echo "<td><a href='customer_client_view.php?logcount=".$logcount."&customer_id=".$row['customer_id']."&username=".$username."'><button class='btn btn-outline-light btn-sm' type='submit'>View</button></a></td>";
        echo "</tr>";
        echo"</tbody>";
    }
    ?>
