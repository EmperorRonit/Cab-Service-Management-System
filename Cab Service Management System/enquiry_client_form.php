            ...
            <div class="row">
              ...
              <h1 class="fw-bold mb-2 text-uppercase">Enquiry</h1><br>
                ...
                <div class="col-md-9 mb-4">
                  <div class="form-outline">
                  <input type="text" class="form-control form-control" placeholder="Full Name" name="customer_name" value="<?php echo $row['customer_name']?>" pattern="[a-zA-Z ]+" title="Please Enter Valid Name"/>
                </div>
                </div>
                </div>
