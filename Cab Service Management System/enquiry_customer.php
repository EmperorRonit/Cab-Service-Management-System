          ...
          <div class="card-body p-5 text-center">
            ...
            <div class="row">
              ...
              <div class="col-md-3 mb-4">
                ...
                <div class="col-md-9 mb-4">
                  <div class="form-outline">
                  <textarea name="enquiry" id="" cols="30" rows="4" class="form-control form-control" placeholder="What you want know?" required></textarea>
                  </div>
                </div>
                </div>
...
<img src="Images/Enquiry.png" alt="Paris" style="height: 520px;  width: 640px; margin-top: 30px; margin-bottom: -520px;"> 
    </div>
