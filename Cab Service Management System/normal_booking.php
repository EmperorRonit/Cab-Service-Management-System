...
<html>
    ...
    while($row = mysqli_fetch_array($res)){
        ...
        echo "<td><a href='normal_b_client_form.php?logcount=".$logcount."&booking_id=".$row['booking_id']."'><button class='btn btn-outline-light btn-sm' type='submit'>View</button></a></td>";
        echo "</tr>";
        echo"</tbody>";
    }
    ?>
