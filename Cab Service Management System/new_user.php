...
if(isset($_POST['create'])){
    ...
    $sql = "insert into logintb(UserName, Password, UserType) values('$UserName', '$Password', '$UserType')";
    
if(mysqli_query($mysqli, $sql)){
    echo "<script>alert('New User Created Sucessfully')</script>";
}
else{
    echo "<script>alert('Faild to Create New User')</script>";
}
}
  ...
  <div class="container py-5 h-100">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-12 col-md-4 col-lg-6 col-xl-5">
        <div class="card bg-dark text-white" style="border-radius: 1rem; height: 550px;">
          <div class="card-body p-5 text-center">
            ...
            <form action="" method="post">
              ...
              <input type="submit" value="Create" name="create" class="btn btn-outline-light btn-lg px-5"><br><br>
            </form>       
            </div>
          </div>
        </div>
