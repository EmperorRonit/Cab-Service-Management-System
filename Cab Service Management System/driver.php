...
<html>
    ...
    <input type="submit" value="Log Report" name="log" class="btn btn-outline-dark btn-lg">    
        ...
        <a href='add_driver.php?logcount=<?php echo $logcount?>&username=<?php echo $username?>'><button type="button" class="btn btn-outline-dark btn-lg" style="margin-left: 1220px; margin-top: -70px;">Add</button></a>
        <br><br>
    ...
    while($row = mysqli_fetch_array($res)){
        ...
        echo "<td><a href='edit_driver.php?logcount=".$logcount."&driver_id=".$row['driver_id']."&username=".$username."'><button class='btn btn-outline-light btn-sm' type='submit'>View</button></a></td>";
        echo "</tr>";
        echo"</tbody>";
    }
    ?>
