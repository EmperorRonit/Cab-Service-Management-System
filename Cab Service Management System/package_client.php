...
<html>
    ...
    <input type="submit" value="Log Report" name="log" class="btn btn-outline-dark btn-lg">    
        ...
        <a href='add_package.php?logcount=<?php echo $logcount?>&username=<?php echo $username?>'><button type="button" class="btn btn-outline-dark btn-lg" style="margin-left: 1225px; margin-top: -70px;">Add</button></a>
        <br><br>
    ...
    while($row = mysqli_fetch_array($res)){
        ...
        echo "<td><a href='edit_package.php?logcount=".$logcount."&package_id=".$row['package_id']."&username=".$username."'><button class='btn btn-outline-light btn-sm' type='submit'>View</button></a></td>";
        echo "</tr>";
        echo"</tbody>";
    }
    ?>
